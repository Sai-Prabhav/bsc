...
export const Courses = () => {
  return <div className="w-full bg-white py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-12">
          <div className="bg-white rounded-lg border border-gray-200 overflow-hidden hover:shadow-lg transition-shadow">
            <div className="p-6">
                ...
                <Link to="/courses" className="inline-flex items-center text-brand-blue hover:text-gradient-blue-end font-semibold">
        ...
        <div className="text-center">
          <Link to="/courses" className="inline-flex items-center justify-center bg-brand-blue text-white px-8 py-4 rounded-lg font-semibold hover:bg-gradient-blue-end transition-colors">
            View All Courses
          </Link>
        </div>
      </div>
